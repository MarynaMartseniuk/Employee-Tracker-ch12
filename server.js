    ...
    .then((res) => {
      ...
      function actionTODO(data) {
        ...
        if (data === "add an employee") {
          ...
          // pool.query('SELECT role.title AS employee_role, role.id AS role_id FROM role',
          pool.query('SELECT  e.id AS Employee_ID, e.first_name AS first_name, e.last_name AS last_name,  role.id AS role_id, role.title AS Jobe_Title, department.name AS Department, role.salary AS Salary, m.id AS manager_id, m.first_name AS manager_first_name, m.last_name AS manager_last_name FROM  employee e LEFT JOIN employee m ON e.manager_id = m.id LEFT JOIN role ON e.role_id = role.id LEFT JOIN department ON role.department_id = department.id',
            function (err, { rows }) {
              ...
              inquirer
                .prompt([
                  ...
                  },
                  {
                    ...
                    message: "What is the manager Last for this new employee?",
